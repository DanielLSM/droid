...
namespace Neodroid.Models.Managers {
  public class SimulationManager : NeodroidManager {
    ...
    public void SetWaitOnEveryOnIndex(int wait_on) { this.WaitOnEvery = (WaitOn)wait_on; }
    ...
    protected override void InnerUpdate() {
      if (this._configuration.WaitEvery == WaitOn.Update)
        this.PauseSimulation();
      if (this.TestMotors) {
    ...
    public bool IsSimulationPaused() { return Math.Abs(Time.timeScale) < Double.Epsilon; }
