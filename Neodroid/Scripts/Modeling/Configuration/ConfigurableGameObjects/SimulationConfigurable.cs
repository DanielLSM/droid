...
namespace Neodroid.Configurations {
  ...
  public class SimulationConfigurable : ConfigurableGameObject {
    ...
    protected override void AddToEnvironment () {
      _quality_level = GetConfigurableIdentifier () + "QualityLevel";
      _target_frame_rate = GetConfigurableIdentifier () + "TargetFrameRate";
      _time_scale = GetConfigurableIdentifier () + "TimeScale";
      _width = GetConfigurableIdentifier () + "Width";
      _height = GetConfigurableIdentifier () + "Height";
      _fullscreen = GetConfigurableIdentifier () + "Fullscreen";
