...
public struct FState : IFlatbufferObject
{
  ...
  public FOBS? Observations(int j) { int o = __p.__offset(14); return o != 0 ? (FOBS?)(new FOBS()).__assign(__p.__indirect(__p.__vector(o) + j * 4), __p.bb) : null; }
  public int ObservationsLength { get { int o = __p.__offset(14); return o != 0 ? __p.__vector_len(o) : 0; } }
  public FOBS? ObservationsByKey(string key) { int o = __p.__offset(14); return o != 0 ? FOBS.__lookup_by_key(__p.__vector(o), key, __p.bb) : null; }
  public Neodroid.FBS.FUnobservables? Unobservables { get { int o = __p.__offset(16); return o != 0 ? (Neodroid.FBS.FUnobservables?)(new Neodroid.FBS.FUnobservables()).__assign(__p.__indirect(o + __p.bb_pos), __p.bb) : null; } }
  ...
  public static Offset<FState> CreateFState(FlatBufferBuilder builder,
    ...
    FState.AddReward(builder, reward);
  ...
  public static void StartFState(FlatBufferBuilder builder) { builder.StartObject(9); }
  ...
  public static void AddUnobservables(FlatBufferBuilder builder, Offset<Neodroid.FBS.FUnobservables> unobservablesOffset) { builder.AddOffset(6, unobservablesOffset.Value, 0); }
