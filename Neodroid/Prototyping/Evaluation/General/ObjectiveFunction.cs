...
namespace Neodroid.Prototyping.Evaluation.General {
  [Serializable]
  public abstract class ObjectiveFunction : MonoBehaviour,
    ...
    public float Evaluate () {
      ...
      signal = signal * Mathf.Pow (this._discount_factor, this._environment.CurrentFrameNumber);
      if (this.Debugging)
        print (signal);
      return signal;
    }
    ...
    [SerializeField] float _discount_factor = 1.0f;
