...
namespace Neodroid.Models.Observers {
  ...
  public class RigidbodyObserver : Observer,
                                   IHasRigidbody {
    [SerializeField] Space3 _angular_space = new Space3(Int32.MaxValue);
    ...
    [SerializeField] Space3 _velocity_space = new Space3(Int32.MaxValue);
    ...
    public Vector3 Velocity {
      ...
      set { this._velocity = this._velocity_space.ClipNormalise(value); }
    }

    public Vector3 AngularVelocity {
      get { return this._angular_velocity; }
      set { this._angular_velocity = this._angular_space.ClipNormalise(value); }
    }
